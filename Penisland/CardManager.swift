...
class CardManager: NSObject {
    ...
    static let card18 = Card(title: "18) Never Have I Ever", short_title: "Never Have I Ever - Group Game", rule_description: "Group Game - The Roller will start a game of \"Never Have I Ever\" and then going clockwise, each person at the table will continue it. All players begin with 3 strikes. If you have done said thing, you lose 1 strike. The first person to lose all 3 strikes is subject to triple the Loser Penalty. After one time around the circle, you may take things up a notch and begin drawing from below.", rules: [
    ...
    static let card22 = Card(title: "22) Admission of Guilt", short_title: "Admission of Guilt - Group Game", rule_description: "Group Game - The Roller will draw an illegal or embarrassing act below. One by one beginning with The Roller, each player must stand up and either confess to the act or plead their innocence. If a player confesses, they're subject to the Loser Penalty. If a player does not confess and another player calls them out with contradictory evidence, they must perform a \"Walk of Atonement\" around the table while saying \"Shame\" repeatedly until their next turn.", rules: [
